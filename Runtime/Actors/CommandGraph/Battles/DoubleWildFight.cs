...
namespace Varguiniano.YAPU.Runtime.Actors.CommandGraph.Battles
{
    ...
    /// </summary>
    [Serializable]
    public class DoubleWildFight : SingleExecutionPathCommandNode
    {
        /// <summary>
        /// Second roster of the opponents.
        /// </summary>
        [InfoBox("First roster is retrieved from the character controller.")]
        [SerializeField]
        private Roster SecondRoster;
                                           ...
                                           Action<CommandParameterData> callback)
        {
            ...
            if (actorCharacter != null)
                parameterData.BattleLauncher.LaunchDoubleWildEncounter(parameterData.PlayerCharacter,
                                                                       new List<Roster>
                                                                       {
