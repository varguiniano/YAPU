...
{
    /// <summary>
    /// Configuration selector for skipping the main menu when opening the game.
    /// </summary>
    public class SkipMainMenuSelector : OptionsMenuItem
    {
        /// <summary>
        ...
        public void Construct(IConfigurationManager configurationManagerReference)
        {
            ...
            SetOption(gameplayConfiguration.SkipMainMenuWhenOpeningGame ? 1 : 0, true);
        }
        ...
        protected override void OnOptionSwitched(bool isFirstSetup)
        {
            ...
            gameplayConfiguration.SkipMainMenuWhenOpeningGame = CurrentIndex == 1;
