...
{
    /// <summary>
    /// Data class representing an item effect that triggers a monster evolution.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Items/Effects/OnTarget/TriggerEvolution",
                     fileName = "TriggerEvolutionOnUseEffect")]
    public class TriggerEvolutionOnUseEffect : UseOnTargetItemEffect
    {
        /// <summary>
        ...
        public override bool IsCompatible(YAPUSettings settings,
            ...
            monsterInstance.FormData.Evolutions.Any(data => data.CanEvolveWhenUsingItem(monsterInstance,
                                                         ...
                                                         Action<bool> finished)
        {
            ...
            EvolutionData evolutionData =
                monsterInstance.FormData.Evolutions.First(data => data.CanEvolveWhenUsingItem(monsterInstance,
                                                              timeManager.DayMoment,
                                                              item,
                                                              playerCharacter,
                                                              out consumeHeldItem));
