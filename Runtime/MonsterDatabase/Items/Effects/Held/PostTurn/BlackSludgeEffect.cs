...
{
    /// <summary>
    /// Similar to the leftovers effect, but can also damage.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Items/Effects/Held/PostTurn/BlackSludgeEffect", fileName = "BlackSludgeEffect")]
    public class BlackSludgeEffect : PostTurnCallbackItemEffect
    {
        /// <summary>
        ...
        /// <summary>
        /// Types healed by this item.
        /// </summary>
        [SerializeField]
        private List<MonsterType> HealedTypes;
                                                        ...
                                                        Action<bool> finished)
        {
            ...
            bool heal = battler.IsOfAnyType(HealedTypes, battleManager.YAPUSettings);

            if (heal && !battler.CanHeal(battleManager)) yield break;

            int amount = 0;

            yield return battleManager.BattlerHealth.ChangeLife(battler,
                                                                battler,
                                                                heal ? hpToChange : -hpToChange,
            ...
            yield return DialogManager.ShowDialogAndWait(heal
                                                             ? "Items/BlackSludge/EffectHeal"
                                                             : "Items/BlackSludge/EffectDamage",
