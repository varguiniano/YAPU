...
{
    /// <summary>
    /// Data class for the move RockSmash.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Fighting/RockSmash", fileName = "RockSmash")]
    public class RockSmash : StageChanceDamageMove
    {
        /// <summary>
        ...
        {
            foreach (BasicSpriteAnimation animation in targetPositions.Select(position =>
