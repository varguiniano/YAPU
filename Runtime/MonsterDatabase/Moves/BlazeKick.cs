...
{
    /// <summary>
    /// Data class for the move BlazeKick.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Fire/BlazeKick", fileName = "BlazeKick")]
    public class BlazeKick : StatusChanceDamageMove
    {
        /// <summary>
                                                  ...
                                                  bool ignoresAbilities)
        {
            ...
            {
                Punch kick = Instantiate(KickPrefab, targetPosition);
