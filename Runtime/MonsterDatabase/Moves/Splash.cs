...
{
    /// <summary>
    /// Data class for the move Splash.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Normal/Splash", fileName = "Splash")]
    public class Splash : Move
    {
        ...
        {
            yield return DialogManager.ShowDialogAndWait("Battle/Move/NoEffect", switchToNextAfterSeconds: 1.5f);
        }
    }
}