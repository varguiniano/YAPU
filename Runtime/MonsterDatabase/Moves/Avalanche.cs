...
{
    /// <summary>
    /// Data class for the move Avalanche.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Ice/Avalanche", fileName = "Avalanche")]
    public class Avalanche : DamageMove
    {
        /// <summary>
