...
{
    /// <summary>
    /// Data class for the move Spikes.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Ground/Spikes", fileName = "Spikes")]
    public class Spikes : SetLayeredSideStatusMove
    {
        /// <summary>
        /// Move's audio.
        /// </summary>
