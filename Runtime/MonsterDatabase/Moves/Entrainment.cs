...
{
    /// <summary>
    /// Data class for the Entrainment move.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Normal/Entrainment", fileName = "Entrainment")]
    public class Entrainment : SetVolatileStatusMove
    {
        // TODO: Animation.
        ...
        protected override object[] PrepareExtraData(BattleManager battleManager,
                                                     ...
                                                     int targetIndex) =>
            new object[] {battleManager.Battlers.GetBattlerFromBattleIndex(userType, userIndex).GetAbility()};
    }
}