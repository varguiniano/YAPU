...
{
    /// <summary>
    /// Data class for the move MagicRoom.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Psychic/MagicRoom", fileName = "MagicRoom")]
    public class MagicRoom : SetGlobalStatusMove
    {
        /// <summary>
