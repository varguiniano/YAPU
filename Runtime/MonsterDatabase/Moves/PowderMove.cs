...
{
    /// <summary>
    /// Data class for the move cycle that spreads powder and sets a status.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/General/PowderMove", fileName = "PowderMove")]
    public class PowderMove : SetStatusMove
    {
        /// <summary>
