...
{
    /// <summary>
    /// Class representing the move DragonDance.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Dragon/DragonDance", fileName = "DragonDance")]
    public class DragonDance : StageChangeMove
    {
        /// <summary>
        /// Particle texture.
        /// </summary>
                                                  ...
                                                  bool ignoresAbilities)
        {
            ...
            yield return sprite.Pivot.DOShakePosition(1.6f / speed, .1f, 3).WaitForCompletion();
        }
    }
}