...
{
    /// <summary>
    /// Data class for the move Psybeam.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Psychic/Psybeam", fileName = "Psybeam")]
    public class Psybeam : StatusChanceDamageMove
    {
        /// <summary>
                                                  ...
                                                  bool ignoresAbilities)
        {
            for (int i = 0; i < targetPositions.Count; i++)
            {
                ...
                DOTween.To(() => tone,
                       ...
                       .OnUpdate(() => effect.midtones.SetValue(new Vector4Parameter(tone)))
