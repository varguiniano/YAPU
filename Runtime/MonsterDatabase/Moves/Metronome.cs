...
{
    /// <summary>
    /// Data class for the move Metronome.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Moves/Normal/Metronome", fileName = "Metronome")]
    public class Metronome : Move
    {
                                                  ...
                                                  Action<bool> finishedCallback)
        {
            ...
            do
                move = battleManager.MonsterDatabase.GetMoves(false).Random();
            while (IncompatibleMoves.Contains(move));
