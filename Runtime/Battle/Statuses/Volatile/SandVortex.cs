...
{
    /// <summary>
    /// Data class representing the SandVortex status.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Status/Volatile/SandVortex", fileName = "SandVortex")]
    public class SandVortex : BindingVolatileStatus
    {
        /// <summary>
        ...
        {
            if (showMessages)
                DialogManager.ShowDialog("Status/Volatile/SandVortex/CantRun",
                                         localizableModifiers: false,
                                         acceptInput: false,
                                         modifiers: battler.GetNameOrNickName(battleManager.Localizer),
                                         switchToNextAfterSeconds: 1.5f / battleManager.BattleSpeed);
