...
{
    /// <summary>
    /// Data class representing the FieryVortex status.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Status/Volatile/FieryVortex", fileName = "FieryVortex")]
    public class FieryVortex : BindingVolatileStatus
    {
        /// <summary>
        ...
        /// <summary>
        /// Reference to the frozen status.
        /// </summary>
        [SerializeField]
        private Status FrozenStatus;
        ...
        public override IEnumerator OnTickStatus(BattleManager battleManager, Battler battler)
        {
            ...
            if (battler.GetStatus() == FrozenStatus) yield return battleManager.Statuses.RemoveStatus(battler);
        }
        ...
        {
            if (showMessages)
                DialogManager.ShowDialog("Status/Volatile/FieryVortex/CantRun",
                                         localizableModifiers: false,
                                         acceptInput: false,
                                         modifiers: battler.GetNameOrNickName(battleManager.Localizer),
                                         switchToNextAfterSeconds: 1.5f / battleManager.BattleSpeed);
