...
{
    /// <summary>
    /// Data class for the volatile status of the ability Truant.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Status/Volatile/LoafingAround", fileName = "LoafingAround")]
    public class LoafingAround : VolatileStatus
    {
        /// <summary>
