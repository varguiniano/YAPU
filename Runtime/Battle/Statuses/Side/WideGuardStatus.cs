...
{
    /// <summary>
    /// Data class for the side status of Wide Guard.
    /// </summary>
    [CreateAssetMenu(menuName = "YAPU/Monster Database/Status/Side/WideGuard", fileName = "WideGuardStatus")]
    public class WideGuardStatus : SideStatus
    {
        /// <summary>
        ...
        {
            if (move.AffectedByProtect && move.CanHaveMultipleTargets)
            {
