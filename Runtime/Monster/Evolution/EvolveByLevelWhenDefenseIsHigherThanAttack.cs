...
{
    /// <summary>
    /// Evolution data class that has a monster evolve when it's on or above a certain level and its defense is higher than its attack.
    /// </summary>
    [Serializable]
    public class EvolveByLevelWhenDefenseIsHigherThanAttack : EvolveByLevel
    {
        /// <summary>
            ...
            List<DexMonsterRelationshipData> relationships = new()
                                                             {
                                                                 new DexMonsterRelationshipData
                                                                 {
                                                                     ...
                                                                     LocalizableDescriptionKey =
                                                                         "Dex/Evolutions/ByLevelWhenDefenseIsHigherThanAttack"
                                                                 }
                                                             };
        ...
        public override EvolutionData Clone() =>
            new EvolveByLevelWhenDefenseIsHigherThanAttack
            {
