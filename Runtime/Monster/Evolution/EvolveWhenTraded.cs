...
{
    /// <summary>
    /// Evolution data class that has a monster evolve when it has been traded.
    /// </summary>
    [Serializable]
    public class EvolveWhenTraded : TargetSpeciesAndFormEvolutionData
    {
        /// <summary>
            ...
            List<DexMonsterRelationshipData> relationships = new()
                                                             {
                                                                 new DexMonsterRelationshipData
                                                                 {
                                                                     ...
                                                                     Text = localizer["Dex/Evolutions/Trade"],
                                                                     LocalizableDescriptionKey =
                                                                         "Dex/Evolutions/Trade/Description"
                                                                 }
                                                             };
