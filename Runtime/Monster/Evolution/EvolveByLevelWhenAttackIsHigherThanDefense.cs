...
{
    /// <summary>
    /// Evolution data class that has a monster evolve when it's on or above a certain level and its attack is higher than its defense.
    /// </summary>
    [Serializable]
    public class EvolveByLevelWhenAttackIsHigherThanDefense : EvolveByLevel
    {
        /// <summary>
            ...
            List<DexMonsterRelationshipData> relationships = new()
                                                             {
                                                                 new DexMonsterRelationshipData
                                                                 {
                                                                     ...
                                                                     LocalizableDescriptionKey =
                                                                         "Dex/Evolutions/ByLevelWhenAttackIsHigherThanDefense"
                                                                 }
                                                             };
        ...
        public override EvolutionData Clone() =>
            new EvolveByLevelWhenAttackIsHigherThanDefense
            {
