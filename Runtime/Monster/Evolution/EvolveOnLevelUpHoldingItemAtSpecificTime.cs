...
{
    /// <summary>
    ///  Evolution data class that has a monster evolve when it levels up holding a specific item at a specific time.
    /// </summary>
    [Serializable]
    public class EvolveOnLevelUpHoldingItemAtSpecificTime : EvolveOnLevelUpHoldingItem
    {
        /// <summary>
            ...
            List<DexMonsterRelationshipData> relationships = new()
                                                             {
                                                                 new DexMonsterRelationshipData
                                                                 {
                                                                     ...
                                                                     LocalizableDescriptionKey =
                                                                         "Dex/Evolutions/LevelUpHoldingAtSpecificTime/Description"
                                                                 }
                                                             };
        ...
        public override EvolutionData Clone() =>
            new EvolveOnLevelUpHoldingItemAtSpecificTime
            {
                EvolvingTimes = EvolvingTimes,
