...
{
    /// <summary>
    /// Evolution data class that has a monster evolve when it's on or above a certain level on scenes with specific tags.
    /// </summary>
    [Serializable]
    public class EvolveByLevelWithSceneTag : EvolveByLevel
    {
        /// <summary>
            ...
            CompatibleTags.Select(tag => new DexMonsterRelationshipData
                                         {
                                             ...
                                             LocalizableDescriptionKey = "Dex/Evolutions/ByLevelWithSceneTag",
                                         })
                          .ToList();
