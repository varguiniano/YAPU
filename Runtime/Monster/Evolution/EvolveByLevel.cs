...
{
    /// <summary>
    /// Evolution data class that has a monster evolve when it's on or above a certain level.
    /// </summary>
    [Serializable]
    public class EvolveByLevel : TargetSpeciesAndFormEvolutionData
    {
        /// <summary>
        /// Level to evolve at.
        /// </summary>
                                                   ...
                                                   out bool consumeHeldItem)
        {
            ...
            return monster.AllowEvolution(this) && monster.StatData.Level >= TargetLevel;
        }
