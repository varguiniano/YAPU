...
{
    /// <summary>
    /// Evolution data class that evolves when the monster reaches a certain friendship level.
    /// </summary>
    [Serializable]
    public class EvolveByFriendship : TargetSpeciesAndFormEvolutionData
    {
        /// <summary>
        /// Friendship to evolve at.
        /// </summary>
        [PropertyRange(1, 255)]
        public byte TargetFriendship = 160;
                                                   ...
                                                   out bool consumeHeldItem)
        {
            ...
            return monster.AllowEvolution(this) && monster.Friendship >= TargetFriendship;
        }
            ...
            List<DexMonsterRelationshipData> relationships = new()
                                                             {
                                                                 new DexMonsterRelationshipData
                                                                 {
                                                                     ...
                                                                     LocalizableDescriptionKey =
                                                                         "Dex/Evolutions/ByFriendship/Description"
                                                                 }
                                                             };
